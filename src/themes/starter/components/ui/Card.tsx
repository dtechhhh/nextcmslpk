...
function Card({
  ...
  return (
    <div
      data-slot="card"
      className={cn(
        "group/card flex flex-col gap-4 overflow-hidden rounded-lg bg-white py-4 text-sm",
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-lg border-t border-neutral-100 bg-neutral-50 p-4",
        className
      )}
      {...props}
    />
  ...
  return (
    <div data-slot="card-image" className="relative aspect-[4/3] w-full overflow-hidden">
      <CmsImage
        ...
        fallbackLabel={typeof alt === "string" ? alt : undefined}
        {...props}
      />
    </div>
  )

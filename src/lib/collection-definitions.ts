  ...
  job: {
    ...
    sections: [
      ...
      },
      {
        title: "Transparency",
        fields: [
          { kind: "switch", path: "is_sample_listing", label: "Sample listing" },
          { kind: "text", path: "listing_notice_title", label: "Listing notice title" },
          { kind: "textarea", path: "listing_notice_description", label: "Listing notice description" },
          { kind: "text", path: "verification_label", label: "Verification label" },
          { kind: "text", path: "visa_path_label", label: "Visa path label" },
          { kind: "text", path: "employer_disclosure_label", label: "Employer disclosure" },
          { kind: "text", path: "employment_model_label", label: "Employment model" },
          { kind: "textarea", path: "hit_role_label", label: "HIT role" },
        ],
      },
      {
        title: "Card info",
        fields: [
          ...
          { kind: "text", path: "salary_basis_label", label: "Salary basis" },
          { kind: "text", path: "estimated_take_home_label", label: "Estimated take-home pay" },
        ],
      },
      {
        title: "Detail content",
        fields: [
          ...
          { kind: "string-array", path: "requirements", label: "Requirements", itemLabel: "Requirement" },
          { kind: "string-array", path: "benefits", label: "Benefits", itemLabel: "Benefit" },
          { kind: "string-array", path: "candidate_fit_items", label: "Candidate fit checklist", itemLabel: "Checklist item" },
          ...
          { kind: "array", path: "work_condition_items", label: "Work conditions", itemLabel: "Condition", defaultItem: titleDescItem, sortOrderField: "sort_order", fields: titleDescFields },
          { kind: "array", path: "compensation_items", label: "Compensation and deductions", itemLabel: "Item", defaultItem: titleDescItem, sortOrderField: "sort_order", fields: titleDescFields },
          { kind: "array", path: "employer_benefit_items", label: "Employer benefits", itemLabel: "Benefit", defaultItem: titleDescItem, sortOrderField: "sort_order", fields: titleDescFields },
          { kind: "array", path: "process_role_items", label: "Process roles", itemLabel: "Role", defaultItem: titleDescItem, sortOrderField: "sort_order", fields: titleDescFields },
          { kind: "array", path: "cost_transparency_items", label: "Cost transparency", itemLabel: "Cost item", defaultItem: titleDescItem, sortOrderField: "sort_order", fields: titleDescFields },
      ...
      },
      {
        ...
        fields: [
          ...whatsappCtaFields,
          { kind: "text", path: "preparation_cta_label", label: "Preparation CTA label" },
          { kind: "text", path: "preparation_cta_href", label: "Preparation CTA href" },
        ],
      },
    ],
  },
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          { kind: "text", path: "batch_label", label: "Batch dates label" },
          { kind: "text", path: "hero_eyebrow_label", label: "Hero eyebrow" },
        ],
      },
      {
        title: "Instructor",
        fields: [
          { kind: "media", path: "instructor_image_id", label: "Instructor photo", cropPreset: "portrait" },
          { kind: "text", path: "instructor_name", label: "Instructor name" },
          { kind: "text", path: "instructor_role", label: "Instructor role" },
          { kind: "text", path: "instructor_qualification", label: "Instructor qualification" },
          { kind: "text", path: "instructor_experience", label: "Instructor experience" },
          { kind: "textarea", path: "instructor_description", label: "Instructor description" },
        ],
      },
      {
        title: "Detail content",
        fields: [
          { kind: "text", path: "intro_heading", label: "Intro heading" },
          { kind: "textarea", path: "detail_description", label: "Detail description" },
          { kind: "text", path: "detail_checklist_title", label: "Checklist heading" },
          ...
          { kind: "array", path: "benefit_items", label: "Benefit items", itemLabel: "Benefit", defaultItem: titleDescItem, sortOrderField: "sort_order", fields: titleDescFields },
          { kind: "array", path: "agenda_items", label: "Agenda items", itemLabel: "Agenda", defaultItem: titleDescItem, sortOrderField: "sort_order", fields: titleDescFields },
  ...
  blog: {
    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          { kind: "string-array", path: "key_takeaways", label: "Key takeaways", itemLabel: "Takeaway" },
          { kind: "text", path: "reviewer_name", label: "Reviewer name" },
          { kind: "text", path: "reviewer_title", label: "Reviewer title" },
          { kind: "date", path: "reviewed_at", label: "Reviewed at" },
          {
            kind: "array",
            path: "source_items",
            label: "Source items",
            itemLabel: "Source",
            defaultItem: newsEvidenceItem,
            sortOrderField: "sort_order",
            fields: newsEvidenceFields,
          },
        ],
      },
      {

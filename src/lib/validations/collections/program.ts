...
export const programSchema = z
  .object({
    ...
    why_choose_items: z.array(itemWithTitleDesc).default([]),
    curriculum_items: z.array(itemWithTitleDesc).default([]),
    timeline_items: z.array(itemWithTitleDesc).default([]),
    ...
    career_opportunity_items: z.array(itemWithTitleDesc).default([]),
    legality_partner_items: z.array(itemWithTitleDesc).default([]),

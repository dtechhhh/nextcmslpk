...
const FIELD_LABELS_BY_PATH: Record<string, string> = {
  ...
  content_type_option_id: "Tipe konten",
  ...
  excerpt: "Ringkasan",
  evidence_items: "Bukti dan sumber",
  ...
  article_line_message_template: "Template pesan LINE artikel",
  article_cta_label: "Label CTA artikel",
  ...
  partner_relevance: "Relevansi bagi mitra",
  price_label: "Harga",
  ...
  reviewer_title: "Jabatan reviewer",
  ...
  tag_option_ids: "Tag",
  key_facts: "Fakta utama",
  key_takeaways: "Ringkasan eksekutif",
...
const GUIDANCE_BY_PATH: Record<string, CmsFieldGuidance> = {
  ...
  content_type_option_id: {
    helpText: "Pilih format editorial agar pembaca memahami apakah konten ini panduan, analisis, laporan, atau pengumuman.",
    usage: "Muncul pada filter, kartu berita, dan metadata artikel.",
  ...
  evidence_items: {
    helpText: "Cantumkan dokumen, halaman resmi, atau sumber publik yang mendukung isi artikel.",
    usage: "Muncul pada bagian bukti dan sumber di halaman detail.",
    requiredForPublish: true,
  },
  key_takeaways: {
    helpText: "Tulis dua sampai empat kesimpulan yang dapat dipahami calon mitra tanpa membaca seluruh artikel.",
    usage: "Muncul sebagai ringkasan eksekutif di halaman detail.",
    requiredForPublish: true,
  },
  partner_relevance: {
    helpText: "Jelaskan keputusan atau tindakan apa yang dapat diambil perusahaan Jepang setelah membaca artikel ini.",
    usage: "Muncul pada pembuka artikel sebagai konteks bagi calon mitra.",
    requiredForPublish: true,
  },
  reviewer_name: {
    helpText: "Isi nama orang yang memeriksa ketepatan dan kelayakan publikasi artikel.",
    usage: "Muncul pada catatan review editorial.",
    requiredForPublish: true,
  },
  hero_image_id: {

  ...
  },
  {
    ...
    optionSets: [
      ...
      optionSet("japan_sector_category", "Japan Sector Category", [
        ...
        { value: "automotive-maintenance", label: "Montir Kendaraan" },
        { value: "welding", label: "Pengelasan" },
        ...
        { value: "road-transport", label: "Sopir Truk dan Bus" },
        { value: "cnc-machining", label: "CNC dan Machining" },
        { value: "restaurant", label: "Restoran" },
        { value: "construction", label: "Konstruksi" },
      ]),
      optionSet("japan_candidate_pathway", "Japan Candidate Pathway", [
        { value: "technical-intern-training", label: "Pemagangan Teknis" },
        { value: "specified-skilled-worker", label: "Pekerja Berketerampilan Khusus" },
        {
          value: "engineer-humanities-international-services",
          label: "Teknik, Humaniora, dan Layanan Internasional",
        },
      ]),
